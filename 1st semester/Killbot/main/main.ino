...
const int UltraSonic_2_ECHO_pin = 16;
const int UltraSonic_2_TRIGGER_pin = 17;
const int UltraSonic_3_ECHO_pin = 18;
const int UltraSonic_3_TRIGGER_pin = 19;

const int H_Bridge_IN1 = 11;
const int H_Bridge_IN2 = 12;
const int H_Bridge_IN3 = 13;
const int H_Bridge_IN4 = 15;
...
// Definition comments
      ...
      // Definition of Ultrasonic front
      // D9 = Echo (Input)
      // D10 = Trigger (Output)

      // Definition of Ultrasonic right
      // DA2 = Echo (Input)
      // DA3 = Trigger (Output)

       // Definition of Ultrasonic left
      // A4 = Echo (Input)
      // A5 = Trigger (Output)
...
int ultra2() {
  ...
  delayMicroseconds(delay_ultrasonics_us);
  digitalWrite(UltraSonic_2_TRIGGER_pin, LOW);

  trigger_2_US = pulseIn(UltraSonic_2_ECHO_pin, HIGH);
  distance_2_US = trigger_2_US / 59;  //distancia en centimetros
  //Serial.print("Distancia: ");
  //Serial.print(distance_1_US);
  //Serial.println(" cm");
  delay(delay_ultrasonics_ms);
